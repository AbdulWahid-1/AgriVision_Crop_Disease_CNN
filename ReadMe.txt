...
| :--- | :--- | :--- |
| **mAP@0.5** | `0.4931` | High-level detection accuracy measured at a standard 50% Intersection over Union (IoU) threshold. |
| **mAP@0.5:0.95** | `0.6283` | A rigorous composite metric averaging precision across stricter overlap thresholds from 50% to 95%. |
...
* **GPU:** NVIDIA GeForce RTX 4050 Laptop GPU (6GB VRAM) running CUDA 12.6 for accelerated tensor operations.
* **CPU:** Intel Multi-Core Architecture handling system orchestration and single-process data loading.
* **RAM:** High-capacity system memory dedicated to dataset RAM caching.
* **OS:** Microsoft Windows (x64) utilizing custom execution guards.

---

## Tech Stack & Libraries

* **Core Framework:** Ultralytics YOLOv8 (`ultralytics`)
* **Deep Learning Backend:** PyTorch (`torch`, `torchvision` with CUDA support)
* **Image Processing:** OpenCV (`cv2`)
* **Logging & Visualization:** Pandas (`pandas`), Matplotlib (`matplotlib`)
